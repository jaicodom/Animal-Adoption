...
$run_query_user = mysqli_query($connect, $sql_user);
    ...
    $tbody .= "
      <div class='col'>
          <div class='card shadow-sm'>
            <img src='animals/pictures/$row[picture]' class='card-img-top '>
            ...
            <div class='card-body'>
              ...
              <div class='d-flex justify-content-between align-items-center'>
                ...
                <a href='animals/details.php?id=$row[id]' class='btn btn-lg btn-primary'>+ INFO</a>    
      ...
      <div class="container">
        ...
        <div class="d-flex flex-wrap align-items-center  justify-content-lg-center ">
          ...
          <div class="nav col-12 col-lg-auto justify-content-center text-black ">
            ...
            <a href="animals/seniors.php" class="nav-link">
              <svg class="bi d-block mx-auto mb-1" width="24" height="24">
          ...
          <div class="hero">
            <img class="userImage rounded-circle w-50 h-50" src="users/pictures/<?php echo $row_user['picture']; ?>" alt="<?php echo $row_user['first_name']; ?>">
            <p>Hi <?php echo $row_user['first_name'] . ",<br> " . $row_user['email']; ?></p>
