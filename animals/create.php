        ...
        <fieldset class="m-5">
            ...
            <form action="../actions/a_create.php" method="post" enctype="multipart/form-data">
                <table class='table'>
                    ...
                    <tr>
                        <th>Description</th>
                        <td><input class="form-control" name="description" placeholder="Write a short description (max 255 charachters)" required>
                    ...
                    <tr>
                        <th>Age</th>
                        <td><input class="form-control" type="number" name="age" step="1" placeholder="Enter an age" maxlength="3" required>

                        </td>
                    </tr>
                    <tr>
                        <th>Color</th>
                        <td><input class='form-control' type="text" name="color" placeholder="Enter a color" /></td>
                    </tr>
                    <tr>
                        <th>Vaccinated</th>
                    ...
                    <tr>
                        ...
                        <td><a href="animals_dashboard.php"><button class='btn btn-warning' type="button">Back</button></a></td>
                    </tr>
                </table>
            </form>
        </fieldset>
