...
if ($run_query->num_rows > 0) {
    while ($row = $run_query->fetch_array(MYSQLI_ASSOC)) {
        $tbody .= "<tr>
            <td><img class='img-thumbnail rounded-circle w-25 h-25' src='pictures/" . $row['picture'] . " ' ></td>
...
<body class="bg-success-subtle">
    ...
    <header>
        ...
        <div class="col-2">
            <img class="userImage rounded-circle" src="pictures/admavatar.png" alt="Adm avatar" width="50" height="50">
