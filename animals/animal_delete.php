...
<body class="bg-success-subtle">
    ...
    <div class="container m-5">
        <fieldset>
            <div class='h4 mb-3'>Do you want to delete this user?
                <img class='img-thumbnail rounded-circle w-25 h-25' src='pictures/<?php echo $picture ?>' alt="<?php echo $name ?>">
            ...
            <form method="post">
                ...
                <a href="animals_dashboard.php"><button class="btn btn-warning" type="button">No</button></a>
            </form>
        </fieldset>
    </div>
</body>
